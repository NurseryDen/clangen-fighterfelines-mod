...
#ff_mod edit: allows players w/ any aged cat to choose a mate 
        ...
        # Roles Tab
            ...
            if 'have kits' not in game.switches:
                    game.switches['have kits'] = True
                    #ff_mod edit: allows player to have kits as an apprentice/kit
            if self.the_cat.age in ['young adult', 'adult', 'senior adult', 'senior', 'adolescent', 'kitten'] and not self.the_cat.dead and not self.the_cat.outside and game.switches['have kits']:
        ...
        # Dangerous Tab
            ...
            # ff_mod edit: allows kittens to have affairs..? why not!
            if game.clan.your_cat.status == 'kitten':
                if self.join_df_button:
                    self.join_df_button.hide()
