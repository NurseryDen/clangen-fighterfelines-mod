...
class Cat():
    ...
    def is_potential_mate(self,
        ...
        # check for age
        # ff_mod edit: allows for young cats to be potential mates
        if age_restriction:
            ...
            # ff_mod edit: disables age group checking
            # (theres a way to change this in the config settings, but just to be sure i disabled it for good.)
        ...
        # ff_mod edit: allows cats of any age/rank to be potential mates
        ...
        # Current mentor
        # ff_mod edit: allows mentors/apprentices to be mates
        if other_cat.ID in self.apprentice or self.ID in other_cat.apprentice:
            return True
        
        # ff_mod edit: allows former mentors to be mates
        # (theres an ingame setting for this but. why not??)
    ...
    def is_dateable(self,
        ...
        # ff_mod edit: allows lifegen incest
        if self.is_related(other_cat, game.clan.clan_settings["first cousin mates"]):
            return True
        ...
        # ff_mod edit: fixes the above :3 (allows lifegen pedo)
        if age_restriction:
        ...
        # check for mentor
        # ff_mod edit: allows mentors/apps to mate in lifegen
        is_former_mentor = (other_cat.ID in self.former_apprentices or self.ID in other_cat.former_apprentices)
        if is_former_mentor and not game.clan.clan_settings['romantic with former mentor']:
            return True
        if other_cat.ID in self.apprentice or self.ID in other_cat.apprentice:
